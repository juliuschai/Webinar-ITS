                ...
                <td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;"> 
                    <table cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td>
                                <center>
                                    <p class="col-md-5 col-sm-5" style="font-size: 14px; text-align: center; margin-bottom: 10px;">Selamat ! </br> Webinar anda dengan Topik {{ $topic }} yang dimulai pada {{ $start_time }} sudah terdaftar.</p>
                                </center>
                            </td>
                        </tr>
                        <tr>
                            <td style="font-size: 14px; border-bottom:1px solid #f2f3f5;">
                                <center>
                                <p class="col-md-5 col-sm-5" style="font-size: 14px; text-align: center; margin-bottom: 10px;">Link Webinar : <a href="{{ $join_url }}">{{ $join_url }}</a> </p>
                                </center>
                            </td>
                        </tr>
                    </table>
